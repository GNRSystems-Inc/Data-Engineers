...
CREATE TABLE Type_Of_User_Account (
  Type_Of_User_Account_ID INT PRIMARY KEY,
  Type_Of_User_Account VARCHAR(10) NOT NULL
);
...
-- ADD COLUMN Course_Category_ID INT,
-- ADD CONSTRAINT FK_Course_Category_ID
--     FOREIGN KEY (Course_Category_ID)
--     REFERENCES Course_Category(Course_Category_ID);

INSERT INTO Course_Sub_Category (Course_Sub_Category_ID, Course_Sub_Category_Name, Course_Category_ID) VALUES
  (1,'Web Development', 1),
  (2,'Data Science', 1), 
  (3,'Communication', 2),
  (4,'Management', 2),    
...
CREATE TABLE Skills (
    ...
    FOREIGN KEY (Course_Sub_Category_ID)
    REFERENCES Course_Sub_Category(Course_Sub_Category_ID)
);

-- ALTER TABLE Skills
-- ADD COLUMN Course_Sub_Category_ID INT,
-- ADD CONSTRAINT FK_Course_Sub_Category_ID
--     FOREIGN KEY (Course_Sub_Category_ID)
--     REFERENCES Course_Sub_Category(Course_Sub_Category_ID);


INSERT INTO Skills (Skill_ID, Skill_Name, Course_Sub_Category_ID) VALUES
  (1, 'Java Script', 1),
  (2, 'React JS', 1),
...
INSERT INTO Approval_Status (Approval_Status_Type) VALUES 
('Approved'),
('Not Approved');
...
CREATE TABLE User (
    ...
    Time_Zone_ID INT,
    Account_Registration_TimeDateStamp DATETIME,
...
-- Inserting data into USER Table (excluding the datetimestamp column)
INSERT INTO USER (User_ID, First_Name, Last_Name, Email, Password, Date_Of_Birth, Type_Of_User_Account_ID, Phone_Number, Time_Zone_ID) VALUES 
(1, 'John', 'Doe', 'john@example.com', 'password123', '1990-01-01', 1, 1234567890, 1),
(2, 'Jane', 'Smith', 'jane@example.com', 'password456', '1995-02-15', 2, 1235647890, 2),
(3, 'Mike', 'Johnson', 'mike@example.com', 'password789', '1985-07-20', 1, 5556667777, 3),
(4, 'Emily', 'Brown', 'emily@example.com', 'passwordabc', '1988-09-10', 2, 3334445555, 4),
(5, 'Chris', 'Taylor', 'chris@example.com', 'passwordxyz', '1993-04-05', 1, 2223334444, 5),
(6, 'Sarah', 'Wilson', 'sarah@example.com', 'passworddef', '1998-11-25', 2, 6667778888, 6),
(7, 'David', 'Martinez', 'david@example.com', 'passwordghi', '1991-03-15', 1, 7778889999, 7),
(8, 'Amanda', 'Lee', 'amanda@example.com', 'passwordjkl', '1986-06-30', 2, 8889990000, 8),
(9, 'Ryan', 'Garcia', 'ryan@example.com', 'passwordmno', '1994-08-12', 1, 9990001111, 9),
(10, 'Rachel', 'Nguyen', 'rachel@example.com', 'passwordpqr', '1987-12-28', 2, 1231231234, 10);
...
INSERT INTO Address (Address_ID, User_ID, Address_Line1, Address_Line2, City, State, Country, Zipcode) VALUES 
(1, 1, '123 Main St', 'Apt 101', 'New York', 'NY', 'USA', 10001),
(2, 2, '456 Elm St', NULL, 'Los Angeles', 'CA', 'USA', 90001),
(3, 3, '789 Oak St', NULL, 'Chicago', 'IL', 'USA', 60601),
(4, 4, '101 Pine St', 'Unit 201', 'San Francisco', 'CA', 'USA', 94101),
(5, 5, '234 Maple St', NULL, 'Houston', 'TX', 'USA', 77001),
(6, 6, '567 Cedar St', NULL, 'Miami', 'FL', 'USA', 33101),
(7, 7, '890 Walnut St', 'Suite 301', 'Boston', 'MA', 'USA', 02101),
(8, 8, '111 Birch St', NULL, 'Seattle', 'WA', 'USA', 98101),
(9, 9, '222 Spruce St', NULL, 'Atlanta', 'GA', 'USA', 30301),
(10, 10, '333 Elm St', NULL, 'Dallas', 'TX', 'USA', 75201);
...
(1, 1, 1, 1, 4, 1, 'Introduction to Programming', 1, 'Learn the fundamentals of programming.', 1, 20, 'This course covers basic programming concepts such as variables, loops, and functions.', 1, 1, 49.99, NOW(), 1),
(2, 2, 2, 3, 6, 2, 'Creative Writing Workshop', 2, 'Explore your creativity through writing.', 3, 15, 'This workshop focuses on developing writing skills through various exercises and prompts.', 2, 2, 29.99, NOW(), 1),
(3, 3, 4, 7, 14, 3, 'Art Appreciation Course', 1, 'Discover the world of art through history and analysis.', 2, 25, 'This course explores different art movements, styles, and techniques.', 3, 3, 39.99, NOW(), 1),
(4, 4, 2, 3, 6, 1, 'Introduction to French Language', 2, 'Learn the basics of French language and culture.', 1, 30, 'This course covers essential French vocabulary, grammar, and pronunciation.', 1, 4, 19.99, NOW(), 1);
...
INSERT INTO Course_Schedule (Course_Schedule_ID, Course_ID, Start_Date, End_Date, Start_time, End_time) VALUES 
(1, 1, '2024-05-01', '2024-06-01', '09:00:00', '12:00:00'),
(2, 2, '2024-05-15', '2024-07-15', '13:00:00', '16:00:00'),
(3, 3, '2024-06-01', '2024-07-01', '10:00:00', '13:00:00'),
(4, 4, '2024-06-15', '2024-08-15', '14:00:00', '17:00:00');
...
(2, 2, 3, '2024-06-01 09:00:00', 95, 'A+');
